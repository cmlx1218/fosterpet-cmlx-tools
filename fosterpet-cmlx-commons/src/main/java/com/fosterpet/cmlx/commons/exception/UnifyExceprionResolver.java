...
import com.fosterpet.cmlx.commons.exception.translation.AbstractExceptionTranslation;
import com.fosterpet.cmlx.commons.exception.translation.DefaultTranslation;
...
@TranslationScan("com.fosterpet.cmlx.commons.exception.translation")
public class UnifyExceprionResolver implements HandlerExceptionResolver {
    ...
    public UnifyExceprionResolver(LocalValidatorFactoryBean validator, List<AbstractExceptionTranslation> translationList) {
